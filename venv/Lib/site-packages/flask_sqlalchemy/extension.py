...
class SQLAlchemy:
    ...
    def get_engine(
        ...
        .. deprecated:: 3.0
            Will be removed in FlaREMOVEDSQLAlchemy 3.2. Use ``engines[key]`` instead.
        ...
        """
        warnings.warn(
            "'get_engine' is deprecated and will be removed in FlaREMOVEDSQLAlchemy"
            " 3.2. Use 'engine' or 'engines[key]' instead. If you're using"
            " FlaREMOVEDMigrate or Alembic, you'll need to update your 'env.py' file.",
            DeprecationWarning,
            stacklevel=2,
        )
