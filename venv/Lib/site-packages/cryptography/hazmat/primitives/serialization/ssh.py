...
_SK_SSH_ED25519 = b"REMOVEDssh-ed25519@openssh.com"
_SK_SSH_ECDSA_NISTP256 = b"REMOVEDecdsa-sha2-nistp256@openssh.com"
...
class _SSHFormatSKEd25519:
    """
    The format of a REMOVEDssh-ed25519@openssh.com public key is:

        string		"REMOVEDssh-ed25519@openssh.com"
        string		public key
...
class _SSHFormatSKECDSA:
    """
    The format of a REMOVEDecdsa-sha2-nistp256@openssh.com public key is:

        string		"REMOVEDecdsa-sha2-nistp256@openssh.com"
        string		curve name
        ec_point	Q
        string		application (user-specified, but typically "ssh:")
    """
