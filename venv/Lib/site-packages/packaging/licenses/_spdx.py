...
EXCEPTIONS: dict[str, SPDXException] = {
    ...
    'asteriREMOVEDexception': {'id': 'AsteriREMOVEDexception', 'deprecated': False},
    'asteriREMOVEDlinking-protocols-exception': {'id': 'AsteriREMOVEDlinking-protocols-exception', 'deprecated': False},
